# Spezielle Relativitätstheorie II: Impuls und Energie (Umbau) {.unnumbered #sec-srt-impuls-energie-umbau}
...
Diese Überlegung ist eine Plausibilisierung, keine Herleitung: Sie zeigt, wie die Eigenzeit auf den Faktor $\gamma$ führt. Dass gerade diese Ersetzung die passende ist, begründet sie nicht.
...
Im Workbook steht die Rechnung deshalb als Plausibilisierung. Die Formel wird ohne Beweis angegeben. Eine vollständige Herleitung findet sich in der Fachliteratur.
:::
