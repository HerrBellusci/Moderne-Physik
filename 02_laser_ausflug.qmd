...
Das Photon wird absorbiert. Seine Energie geht auf das Atom über. Das Atom wechselt vom Grundzustand $E_1$ in den angeregten Zustand $E_2$. Diesen Vorgang nennt man **Absorption**. Die Darstellung zeigt diesen Übergang.
...
Die stimulierte Emission beschreibt zunächst einen einzelnen atomaren Vorgang: Ein passendes Photon löst eine exakte Kopie seiner selbst aus. Alle Photonen aus derselben Kette solcher Kopiervorgänge haben eine feste Phasenbeziehung zueinander. Solches Licht nennt man **kohärent**. Die Kohärenz ist eine der besonderen Eigenschaften des Laserlichts. Die stimulierte Emission legt dafür den Grund. Wie aus vielen einzelnen Ketten ein einziger geordneter Strahl wird, siehst du im Abschnitt zum Resonator.
