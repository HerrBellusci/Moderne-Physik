(function () {
  ...
  function drawSlider(parent, SRT) {
    SRT.addText(parent, SLIDER.x0, SLIDER.y - 18, "Winkel verändern", "label",
      { fill: "var(--mp-slider-accent, #0b8793)", "font-size": 13, "font-weight": "700" });
    SRT.el("line", { x1: SLIDER.x0, y1: SLIDER.y, x2: SLIDER.x1, y2: SLIDER.y,
      stroke: "var(--mp-slider-track, #cbd5e1)", "stroke-width": 7, "stroke-linecap": "round",
    ...
    SRT.el("line", { x1: SLIDER.x0, y1: SLIDER.y, x2: handleX, y2: SLIDER.y,
      stroke: "var(--mp-slider-accent, #0b8793)", "stroke-width": 7, "stroke-linecap": "round", "pointer-events": "none" }, parent);
    SRT.el("circle", { cx: handleX, cy: SLIDER.y, r: 13, fill: "var(--mp-slider-accent, #0b8793)",
      stroke: "var(--mp-slider-accent, #0b8793)", "stroke-width": 3, "data-rings": "slider-handle", style: "cursor: grab;" }, parent);
