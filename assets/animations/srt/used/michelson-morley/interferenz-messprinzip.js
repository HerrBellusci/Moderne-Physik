(function () {
  ...
  function drawSlider(parent, SRT) {
    SRT.addText(parent, SLIDER.x0, SLIDER.y - 16,
      "Spiegel verschieben",
      "label", { fill: "var(--mp-slider-accent, #0b8793)", "font-size": 13, "text-anchor": "start", "font-weight": "600" });
    ...
    SRT.el("line", {
      ...
      stroke: "var(--mp-slider-accent, #0b8793)", "stroke-width": 7, "stroke-linecap": "round", "pointer-events": "none"
    }, parent);

    SRT.el("circle", {
      cx: handleX, cy: SLIDER.y, r: 13, fill: "var(--mp-slider-accent, #0b8793)",
      stroke: "var(--mp-slider-accent, #0b8793)", "stroke-width": 3,
