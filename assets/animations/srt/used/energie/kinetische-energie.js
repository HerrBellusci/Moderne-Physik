(function () {
  ...
  function drawSlider(parent, SRT, beta) {
    ...
    SRT.el("line", { x1: SL.x0, y1: SL.y, x2: SL.x1, y2: SL.y,
      stroke: "var(--mp-slider-track, #cbd5e1)", "stroke-width": 8, "stroke-linecap": "round",
      "data-kin-energy": "track", style: "cursor:pointer;" }, parent);
    SRT.el("line", { x1: SL.x0, y1: SL.y, x2: x, y2: SL.y,
      stroke: "var(--mp-slider-accent, #0b8793)", "stroke-width": 8, "stroke-linecap": "round", "pointer-events": "none" }, parent);
    SRT.el("circle", { cx: x, cy: SL.y, r: 14, fill: "var(--mp-slider-accent, #0b8793)", stroke: "var(--mp-slider-accent, #0b8793)",
