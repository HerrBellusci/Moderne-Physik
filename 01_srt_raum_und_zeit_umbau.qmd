...
Die spezielle Relativitätstheorie betrachtet nur Inertialsysteme. Dieser Abschnitt klärt, was ein Bezugssystem ist und wodurch sich ein Inertialsystem auszeichnet.

Im Alltag sagen wir schnell, etwas sei „wirklich in Ruhe“ oder „wirklich in Bewegung“. Physikalisch ist das ungenau: Ruhe und Bewegung werden immer in einem gewählten Bezugssystem beschrieben.[Bezugssystem]{.column-margin .mp-randbegriff} Ob ein Körper ruht oder sich bewegt, ist also keine absolute Eigenschaft, sondern eine relative Aussage zu einem Bezugssystem. Warum Bewegungen ohne ein festgelegtes Bezugssystem nicht eindeutig beschrieben werden können, zeigt das folgende Video.
...
Am nächsten Bahnhof bremst der Zug. Die Trinkflasche kippt nach vorn. Aus dem Bezugssystem des Zuges scheint sie sich nach vorn zu bewegen, ohne dass eine entsprechende Kraft auf sie wirkt. Um diese Bewegung im bremsenden Zug zu erklären, wird eine Scheinkraft eingeführt.[Scheinkraft]{.column-margin .mp-randbegriff}
...
Bezugssysteme lassen sich danach unterscheiden, ob in ihnen das erste Newtonsche Axiom gilt oder nicht. Bezugssysteme, in denen es gilt, heißen Inertialsysteme.[Inertialsystem]{.column-margin .mp-randbegriff} Beschleunigte Bezugssysteme heißen Nicht-Inertialsysteme.[Nicht-Inertialsystem]{.column-margin .mp-randbegriff} Der Bahnsteig ist in diesem Beispiel ein Inertialsystem, der bremsende Zug dagegen ein Nicht-Inertialsystem.
...
<figure class="srt-workbook-figure srt-workbook-figure--caption-inside">
  ...
  <figcaption>Simulation der Bewegungen A, B und C aus Sicht des mitbewegten Bezugssystems (roter Punkt).</figcaption>
</figure>
```
:::
...
Die folgende interaktive Abbildung zeigt dir den Aufbau eines Michelson-Interferometers.[Michelson-Interferometer]{.column-margin .mp-randbegriff} Klicke nacheinander auf die fünf Bauteile, um sie einzublenden.
...
Die zweite Simulation zeigt dir, welche Veränderung beim Drehen erwartet wurde und was tatsächlich beobachtet wurde. Verändere dazu die Ausrichtung der Apparatur mit dem Rotationsregler.
...
<figure class="srt-workbook-figure srt-workbook-figure--caption-inside">
  ...
  <figcaption>Animation zur Relativität der Gleichzeitigkeit im Zug- und im Bahnsteigsystem.</figcaption>
</figure>
```
:::
...
<figure class="srt-workbook-figure">
  ...
  <figcaption>Skizze der Ausgangslage im Bahnsteigsystem: gleichzeitige Blitzeinschläge an beiden Zugenden, Passagier in der Zugmitte, Fahrtrichtung nach rechts.</figcaption>
</figure>
```
:::
...
<figure class="srt-workbook-figure srt-workbook-figure--caption-inside">
  ...
  <figcaption>Animation der beiden Lichtsignale und des bewegten Passagiers im Zug.</figcaption>
</figure>
```
:::
...
Solche Größen sind invariant.[invariant]{.column-margin .mp-randbegriff} Die kleine Animation soll dir ein Gefühl dafür geben, was das bedeutet:
...
<figure class="srt-workbook-figure">
  ...
  <figcaption>Simulation zur Zeitdilatation mit einer Lichtuhr.</figcaption>
</figure>
```
:::
...
1. Starte mit Gleichung (II): $L_0 = v\,\Delta t$.
2. Setze Gleichung (I) ein: $L_0 = v\,\gamma\,\Delta t_0$.
3. Nutze Gleichung (III), also $v\,\Delta t_0 = L$.
4. Erhalte $L_0 = \gamma\,L$.
5. Stelle diese Gleichung nach $L$ um.
