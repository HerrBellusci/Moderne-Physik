...
```{=html}
<link rel="stylesheet" href="assets/styles/srt-raum-und-zeit.css?v=20260910b">
...
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/michelson-morley/michelson-workbook.css?v=20260907-bedienung">
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/einsteinsche-postulate/konstanz-lichtgeschwindigkeit.css?v=20260908-bedienzeile">
<script src="assets/animations/shared/core.js"></script>
<script src="assets/scripts/train-video.js" defer></script>
<script src="assets/animations/srt1-raum-und-zeit/bezugssysteme/inertialsystem.js?v=20260907-aussenansicht"></script>
<script src="assets/animations/srt1-raum-und-zeit/michelson-morley/bootsanalogie.js?v=20260907-integriert"></script>
<script src="assets/animations/srt1-raum-und-zeit/michelson-morley/interferometer-aufbau.js?v=20260907-textrunde"></script>
<script src="assets/animations/srt1-raum-und-zeit/michelson-morley/aether-vs-nullresultat.js?v=20260907-bedienung"></script>
<script src="assets/animations/srt1-raum-und-zeit/michelson-morley/interferenz-messprinzip.js?v=20260908-reglerfarben"></script>
<script src="assets/animations/srt1-raum-und-zeit/michelson-morley/ringgeometrie.js?v=20260908-reglerfarben"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/gleichzeitigkeit/relativitaet-gleichzeitigkeit.css?v=20260908-bedienzeile">
<script src="assets/animations/srt1-raum-und-zeit/gleichzeitigkeit/relativitaet-gleichzeitigkeit.js?v=20260908-beschriftungen"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/zeitdilatation/lichtuhr.css?v=20260908-schritthilfen">
<script src="assets/animations/srt1-raum-und-zeit/zeitdilatation/lichtuhr.js?v=20260908-zugumriss"></script>
<script src="assets/animations/shared/formelsatz.js?v=20260908"></script>
<script src="assets/animations/srt1-raum-und-zeit/zeitdilatation/lorentzfaktor.js?v=20260908-asymptote"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/invarianz/drehung-abstand.css?v=20260908">
<script src="assets/animations/srt1-raum-und-zeit/invarianz/drehung-abstand.js?v=20260908-abstand"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/zeitdilatation/myon-erdsystem.css?v=20260909-myonsystem">
<script src="assets/animations/srt1-raum-und-zeit/zeitdilatation/myon-erdsystem.js?v=20260909-abstand"></script>
<script src="assets/animations/srt1-raum-und-zeit/laengenkontraktion/ausgangsproblem.js?v=20260909-reduziert"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/doppler/doppler.css?v=20260910b">
<script src="assets/animations/srt1-raum-und-zeit/doppler/doppler-allgemein.js?v=20260910b"></script>
<script src="assets/animations/srt1-raum-und-zeit/doppler/doppler-herleitung.js?v=20260910b"></script>
<script src="assets/animations/srt1-raum-und-zeit/doppler/doppler.js?v=20260910b"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/paradoxien/garagenparadoxon.css?v=20260911-stabile-ansicht">
<script src="assets/animations/srt1-raum-und-zeit/paradoxien/garagenparadoxon.js?v=20260911-abschlusstext"></script>
<link rel="stylesheet" href="assets/animations/srt1-raum-und-zeit/raumfahrt/raumfahrt-aufgabe.css?20260911-uhrsymbole">
<script src="assets/animations/srt1-raum-und-zeit/raumfahrt/raumfahrt-aufgabe.js?20260911-uhrsymbole"></script>
...
<div class="mp-train-video" data-train-video>
  <div class="srt-video-frame">
    <video controls preload="metadata" playsinline poster="assets/images/zug-relativbewegung-poster.jpg" aria-label="Videos zur Relativbewegung zweier Züge" src="Videos%20einbinden/Zugf%C3%A4hrt%20aus.mp4">
  ...
  <div class="mp-train-controls" role="group" aria-label="Zugszene starten" hidden>
    <button type="button" data-train-choice="random" aria-pressed="false">Zufällig starten</button>
    <button type="button" data-train-choice="moving" aria-pressed="false">Zug fährt aus</button>
    <button type="button" data-train-choice="stationary" aria-pressed="false">Zug steht</button>
  </div>
...
![](assets/images/zug-relativbewegung-poster.jpg){fig-alt="Blick auf einen Tisch im Zug am Anfang des digital erstellten Videos."}
...
<script src="assets/animations/srt1-raum-und-zeit/einsteinsche-postulate/konstanz-lichtgeschwindigkeit.js?v=20260908-tempo"></script>
```
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/zeitdilatation/lichtuhr-aufbau.svg){fig-alt="Zwei parallele Spiegel im Abstand D. Lichtquelle und Zähler befinden sich am unteren Spiegel."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/zeitdilatation/lichtuhr-vergleich.svg){fig-alt="Lichtuhr im Zugsystem mit senkrechtem Lichtweg und im Bahnsteigsystem mit diagonalem Lichtweg."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/zeitdilatation/myon-klassisch.svg){fig-alt="Beispielmyon ohne Zeitdilatation. Seine Flugstrecke von 660 Metern bis zum angenommenen Zerfall ist viel kürzer als die Entstehungshöhe von 10 Kilometern."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/zeitdilatation/myon-relativistisch.svg){fig-alt="Das Beispielmyon erreicht mit Zeitdilatation den Erdboden nach 10 Kilometern Flugstrecke, bevor seine angenommene Lebensdauer im Erdsystem verstrichen ist."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/laengenkontraktion/ausgangsproblem.svg){fig-alt="Ruhendes Beispielmyon ohne Längenkontraktion. Der zunächst 10 Kilometer entfernte Boden bewegt sich während 2,2 Mikrosekunden um 659 Meter auf das Myon zu und erreicht es vor dem angenommenen Zerfall nicht."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/laengenkontraktion/myon-system-kontrahiert.svg){fig-alt="Ruhendes Beispielmyon mit Längenkontraktion. Der zunächst 632 Meter entfernte Boden erreicht es nach etwa 2,11 Mikrosekunden, vor seiner angenommenen Eigenlebensdauer von 2,2 Mikrosekunden."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/raumfahrt/raumfahrt-aufgabe.svg){fig-alt="Die Raumschiffspitze passiert zuerst Station A und später Station B. Im Stationssystem ruhen A und B im Abstand von neun Lichtminuten, das Raumschiff bewegt sich mit 0,6 c."}
:::
...
::: {.content-visible unless-format="html"}
![](assets/animations/srt1-raum-und-zeit/paradoxien/garagenparadoxon.svg){fig-alt="Ausgangszustand im Garagensystem vor der Einfahrt: Das bewegte Auto ist 3 Meter lang, die Garage 4 Meter. Beide Tore sind offen."}
:::
