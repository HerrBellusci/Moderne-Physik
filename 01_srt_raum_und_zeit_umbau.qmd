# Spezielle Relativitätstheorie I: Raum und Zeit (Umbau) {.unnumbered}
...
Noch ein Blick zurück auf die kleine $0$: Größen wie die Eigenzeit, die im eigenen Ruhesystem gemessen werden, sind invariant.[invariant]{.column-margin .mp-randbegriff} Über ihren Wert sind sich alle Inertialsysteme einig. Die kleine Animation soll dir ein Gefühl dafür geben, was das bedeutet:
...
<p>Diese Flugstrecke ist größer als die Entstehungshöhe von etwa $10\,\mathrm{km}$. Aus der Erdperspektive reicht die zeitgedehnte mittlere Lebensdauer also gerade aus, damit das Myon den Detektor am Boden erreicht. Die folgende Animation mit Zeitdilatation veranschaulicht das:</p>
