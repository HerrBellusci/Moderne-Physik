...
<link rel="stylesheet" href="assets/animations/laser/rubinlaser.css?v=20260922d">
...
## Der Rubinlaser {#aufbau-eines-lasers-der-erste-laser}
...
Die für den Laserbetrieb wesentlichen Übergänge lassen sich mit dem bereits bekannten [Drei-Niveau-Modell](#besetzungsinversion-und-lasermedium) beschreiben. $E_1$ bezeichnet den Grundzustand, $E_2$ das metastabile Laserniveau und $E_3$ das höher liegende Pumpniveau. Der Laserübergang führt von $E_2$ nach $E_1$. Das Pumpniveau $E_3$ steht hier vereinfacht für mehrere höhere Energiezustände der Chrom-Ionen im Rubin.

Als Pumpquelle dient eine Blitzlampe, die den Rubinstab umgibt.[optisches Pumpen]{.column-margin .mp-randbegriff} Die Lampe enthält das Edelgas Xenon. Bei einer kurzen elektrischen Entladung regen Elektronenstöße das Gas an, sodass es einen hellen Lichtblitz aussendet. Die Chrom-Ionen absorbieren vor allem dessen grüne und blauviolette Anteile und gelangen von $E_1$ in das Pumpniveau $E_3$. Anschließend geben sie einen Teil der aufgenommenen Energie an den Kristall ab und erreichen rasch das metastabile Niveau $E_2$. Dort können sich viele angeregte Ionen ansammeln.
...
Dieser mit einer Blitzlampe gepumpte Rubinlaser arbeitet in Pulsen. Er sendet sein Laserlicht in zeitlich begrenzten Impulsen aus. Diese Betriebsart heißt gepulster Betrieb.[gepulster Betrieb]{.column-margin .mp-randbegriff} Der Blitz liefert die nötige Pumpenergie nur für kurze Zeit. Bereits während des Blitzes kann der Rubinlaser Licht aussenden. Sobald die Anregung nicht mehr ausreicht, um die Lichtverstärkung aufrechtzuerhalten, endet die Laseremission. Ein Lampenblitz kann mehrere kurze Intensitätsspitzen der Laseremission hervorrufen.

@fig-umbau-rubin-aufbau zeigt die auseinandergelegten Teile von Maimans Rubinlaser. Im zusammengesetzten Aufbau befindet sich der Rubinstab innerhalb der wendelförmigen Blitzlampe. Der Aluminiumreflektor umschließt beide und lenkt einen Teil des nach außen abgestrahlten Pumplichts zum Rubin zurück. Die Resonatorspiegel sind auf dem Foto nicht einzeln erkennbar, denn sie befinden sich direkt auf den Stirnflächen des Rubinstabs.

::: {.column-margin}
Im [SPIE-Video „Celebrating 50 Years of the Laser“](https://www.youtube.com/watch?v=eQQeSUvgmJE&t=327s) zeigt Theodore Maiman die Bauteile seines Rubinlasers. Der kurze Ausschnitt beginnt bei etwa 5:27 und endet bei etwa 5:45.
:::
...
```
::: {.content-visible unless-format="html"}
![](assets/images/laser/maiman-komponenten.jpg){fig-alt="Auseinandergelegte Bauteile von Maimans Rubinlaser, oben der Aluminiumreflektor, unten links die Blitzlampe und unten rechts der Rubinstab."}
:::
...
@fig-umbau-tattoo-video zeigt eine Tattooentfernung mit einem Laser. Ab etwa 0:30 sind schwarze und rote Bereiche der Tätowierung zu sehen. Die folgende Aufgabe bezieht sich auf die Behandlung eines roten Tattoos mit einem Rubinlaser.

:::: {#fig-umbau-tattoo-video}
::: {.content-visible when-format="html"}
```{=html}
<video controls preload="none" playsinline width="854" height="480" style="width:100%;height:auto" aria-label="Laser tattoo removal: Video einer Tattooentfernung" poster="https://thumb.wikimedia.org/wikipedia/commons/thumb/1/15/Laser_tattoo_removal.ogv/960px--Laser_tattoo_removal.ogv.jpg">
  <source src="https://upload.wikimedia.org/wikipedia/commons/transcoded/1/15/Laser_tattoo_removal.ogv/Laser_tattoo_removal.ogv.480p.vp9.webm" type="video/webm">
  <source src="https://upload.wikimedia.org/wikipedia/commons/1/15/Laser_tattoo_removal.ogv" type="video/ogg">
  <a href="https://commons.wikimedia.org/wiki/File:Laser_tattoo_removal.ogv">Video auf Wikimedia Commons ansehen</a>
</video>
```
:::

Video „Laser tattoo removal“ von Melissa Findley, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Laser_tattoo_removal.ogv), [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.de). Inhaltlich unverändert eingebunden. Lasertyp und Behandlungswellenlänge sind in der Quelle nicht angegeben.
::::
...
Der gerade betrachtete Rubinlaser wird nur während der Lampenblitze gepumpt und sendet deshalb zeitlich begrenzt Laserlicht aus. Viele Anwendungen brauchen stattdessen einen Strahl, der ununterbrochen leuchtet: der stehende rote Punkt eines Laserpointers, der Abtaststrahl einer Scannerkasse, die dauerhaft projizierte Linie eines Baustellenlasers.
