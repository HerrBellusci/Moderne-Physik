(function () {
  window.SRTSlide.register("inertial", ({ parent, t, SRT }) => {
    ...
    drawPanel(parent, SRT, xs[0], panelY, panelW, panelH, "System A");
    drawPanel(parent, SRT, xs[1], panelY, panelW, panelH, "System B");
    drawPanel(parent, SRT, xs[2], panelY, panelW, panelH, "System C");
    ...
    SRT.addText(parent, 431, 470, "Welches System ist inertial? Begründe nur mit der Bewegung.", "label", { "text-anchor": "middle" });
  });
