...
<link rel="stylesheet" href="../assets/animations/srt1-raum-und-zeit/einsteinsche-postulate/konstanz-lichtgeschwindigkeit.css">
<script src="../assets/animations/shared/core.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/bezugssysteme/inertialsystem.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/michelson-morley/interferometer-aufbau.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/michelson-morley/aether-vs-nullresultat.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/michelson-morley/interferenz-messprinzip.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/michelson-morley/ringgeometrie.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/gleichzeitigkeit/relativitaet-gleichzeitigkeit.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/zeitdilatation/lichtuhr.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/zeitdilatation/lorentzfaktor.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/invarianz/drehung-abstand.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/zeitdilatation/myon-erdsystem.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/laengenkontraktion/ausgangsproblem.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/doppler/doppler-allgemein.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/doppler/doppler-herleitung.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/doppler/doppler.js"></script>
<script src="../assets/animations/srt1-raum-und-zeit/paradoxien/garagenparadoxon.js"></script>
...
Die folgende interaktive Abbildung zeigt dir den Aufbau eines Michelson-Interferometers. Klicke nacheinander auf die fünf Bauteile, um sie einzublenden.
...
<details class="mp-details">
  ...
  <p>Diese beiden Simulationen sind Zusatzmaterial. Sie können dir helfen, das Messprinzip eines Michelson-Interferometers besser zu verstehen.</p>
...
::: {.content-visible unless-format="html"}
::: {.srt-workbook-fallback}
In der HTML-Version erscheinen hier interaktive Darstellungen zu Aufbau, Äther-Erwartung, Nullresultat und optionalem Interferenzsignal.
...
<script src="../assets/animations/srt1-raum-und-zeit/einsteinsche-postulate/konstanz-lichtgeschwindigkeit.js"></script>
```
:::
...
<summary>Was bedeutet die kleine 0?</summary>
<p>Die kleine $0$ heißt: aus der Ruhe betrachtet. Sie markiert eine Größe, die im eigenen Ruhesystem des Objekts gemessen wird. Genauso begegnet sie dir später bei der Eigenlänge $L_0$, der Ruhemasse $m_0$ und der Ruheenergie $E_0$.</p>
<p>Solche Größen sind invariant. Die kleine Animation soll dir ein Gefühl dafür geben, was das bedeutet:</p>
<figure class="srt-workbook-figure">
...
<p>Drehen sich die Punkte A und B um den Ursprung, ändern sich ihre Koordinaten fortlaufend. Der Abstand zwischen ihnen bleibt gleich, er ist invariant.</p>
</details>
...
Relativistische Effekte treten nicht einzeln auf. Wenn sich zwei Inertialsysteme relativ zueinander bewegen, treten Längenkontraktion, Zeitdilatation und Relativität der Gleichzeitigkeit gemeinsam auf. Viele scheinbare Paradoxien lösen sich auf, wenn man diese Effekte gemeinsam betrachtet.
:::
