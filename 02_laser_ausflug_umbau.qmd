...
Animation zur Absorption: Ein Photon mit passender Energie trifft auf ein Atom im Grundzustand, wird absorbiert, und das Atom wechselt in den angeregten Zustand. <span class="mp-caption-warn">Der Wellenzug stellt ein einzelnes Photon mit seiner Frequenz dar. Die Wellenlinie ist keine Flugbahn des Photons.</span>
:::
:::
...
Animation zur spontanen Emission. Ein angeregtes Atom geht ohne einfallendes Photon in das niedrigere Energieniveau über. Dabei entsteht ein Photon. Zeitpunkt und Ausbreitungsrichtung variieren von Durchlauf zu Durchlauf.
::::
...
Animation zur stimulierten Emission. Ein Photon mit passender Energie trifft auf ein angeregtes Atom und löst den Übergang in das niedrigere Energieniveau aus. Danach breiten sich zwei Photonen gleicher Energie in dieselbe Richtung aus.
::::

Bis hierher haben wir die stimulierte Emission im Photonenmodell beschrieben. Für die Phasenbeziehung des Lichts verwenden wir nun das Wellenmodell. Beide Modelle beschreiben dasselbe Licht, beantworten aber unterschiedliche Fragen.

Im Wellenmodell ist die neu entstehende Lichtwelle gleichphasig zur einfallenden Lichtwelle. Wellenberg liegt auf Wellenberg und Wellental auf Wellental. Löst das so entstandene Licht weitere stimulierte Emissionen aus, setzt sich diese Gleichphasigkeit innerhalb der entstehenden Kette fort.

Diese Gleichphasigkeit ist ein idealisierter Sonderfall von Kohärenz.[Kohärenz]{.column-margin .mp-randbegriff} Im hier verwendeten vereinfachten Grenzfall nennen wir zwei Lichtwellen kohärent, wenn ihre relative Phasenlage gleich bleibt. Sie dürfen gegeneinander verschoben sein. Der Versatz muss also nicht null sein.

::: {.column-margin}
Der vollständige Kohärenzbegriff geht über diese vereinfachte Beschreibung hinaus. Räumliche Kohärenz beschreibt Zusammenhänge des Lichtfeldes an verschiedenen Orten, zeitliche Kohärenz an verschiedenen Zeitpunkten. Beide sind graduelle Größen. Pieper entwickelt diese Unterscheidung experimentell am Doppelspalt und am Michelson-Interferometer [@pieper2019kohaerenz, S. 14–24].
:::

Kohärenz wird bei Interferenzversuchen über den Kontrast des Interferenzmusters beobachtbar. Ändert sich die relative Phasenlage gezielt, verschiebt sich das Muster. Schwankt sie dagegen während der Beobachtung schnell und unregelmäßig, überlagern sich unterschiedliche Lagen des Musters und sein Kontrast nimmt ab. Eine erwartete Verschiebung des Interferenzmusters hast du beim Michelson-Morley-Experiment im [Kapitel zu Raum und Zeit](01_srt_raum_und_zeit_umbau.qmd#michelson-morley-experiment) kennengelernt.
